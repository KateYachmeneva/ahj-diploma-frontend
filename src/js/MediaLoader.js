...
export default class MediaLoader {
  ...
  openMedia(event) {
    ...
    let formName = 'аудио';
    if (event.target.classList.contains('media_add_video')) {
  ...
  openMediaForm(formName) {
    ...
    this.addMediaElement = DrawUI.getMediaForm(formName);
    ...
    this.recordStart = this.addMediaElement.querySelector('.media_media_record');
    this.recordStop = this.addMediaElement.querySelector('.media_media_stop');
    this.statusRecord = this.addMediaElement.querySelector('.media_media_status');
  ...
  showError() {
    ...
    this.closeElement = DrawUI.getCloseForm();
    this.addMediaElement = DrawUI.errorMediaForm();
    this.formElement.append(this.closeElement, this.addMediaElement, this.clipElement);
