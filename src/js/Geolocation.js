...
// import GeolocValidator from './GeolocValidator';
...
export default class Geolocation {
  ...
  addCoords(coords) {
    ...
    this.geoElement = DrawUI.createGeoElement(value);
    this.formElement.append(this.geoElement);

    const closeElement = this.geoElement.querySelector('.media_geo_close');
